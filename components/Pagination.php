    ...
    public function get()
    {
        ...
        for ($page = $limits[0]; $page <= $limits[1]; $page++) {
            ...
            if ($page == $this->current_page) {
                $links .= '<li class="spage"><a href="#">' . $page . '</a></li>';
            } else {
                # Иначе генерируем ссылку
                $links .= str_replace("cat/cat", "page", $this->generateHtml($page));
...
//print_r($links);die;
    ...
    private function generateHtml($page, $text = null)
    {
        ...
        return
            '<li ><a href="' . $this->index . $page . '">' . $text . '</a></li>';

         //для корректной работы пришлось убрать
         //. $currentURI . $this->index
    }
    /**
